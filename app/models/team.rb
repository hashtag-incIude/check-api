class Team < ApplicationRecord
  ...
  after_save :upload_custom_status_strings_to_transifex, if: proc { |t| t.respond_to?(:did_custom_statuses_change?) && t.did_custom_statuses_change?(t.settings_before_last_save) }
