SourceType = Mutations::GraphqlCrudOperations.define_default_type do
  name 'Source'
  ...
  instance_exec :source, &Mutations::GraphqlCrudOperations.field_annotations

  instance_exec :source, &Mutations::GraphqlCrudOperations.field_annotations_count

  instance_exec :source, &Mutations::GraphqlCrudOperations.field_log

  instance_exec :source, &Mutations::GraphqlCrudOperations.field_log_count
end
