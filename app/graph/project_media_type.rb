ProjectMediaType = Mutations::GraphqlCrudOperations.define_default_type do
  name 'ProjectMedia'
  ...
  instance_exec :project_media, &Mutations::GraphqlCrudOperations.field_log

  instance_exec :project_media, &Mutations::GraphqlCrudOperations.field_log_count
  ...
  instance_exec :project_media, &Mutations::GraphqlCrudOperations.field_published
  ...
  instance_exec :project_media, &Mutations::GraphqlCrudOperations.field_annotations

  instance_exec :project_media, &Mutations::GraphqlCrudOperations.field_annotations_count
