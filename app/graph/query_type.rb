QueryType = GraphQL::ObjectType.define do
  ...
  field :team do
    ...
    resolve -> (_obj, args, ctx) do
      ...
      Mutations::GraphqlCrudOperations.load_if_can(Team, tid, ctx)
    end
  end
  ...
  instance_exec ProjectMedia, :project_media, ProjectMediaType , &Mutations::GraphqlCrudOperations.project_association

  instance_exec ProjectSource, :project_source, ProjectSourceType , &Mutations::GraphqlCrudOperations.project_association
  ...
  field :project do
    ...
    resolve -> (_obj, args, ctx) do
      ...
      Mutations::GraphqlCrudOperations.load_if_can(Project, id, ctx)
    end
  end
  ...
  [:source, :user, :task, :tag_text, :bot_user].each do |type|
    field type do
      ...
      argument :id, !types.ID
      resolve -> (_obj, args, ctx) do
        Mutations::GraphqlCrudOperations.load_if_can(type.to_s.camelize.constantize, args['id'], ctx)
      end
    end
  end
end
