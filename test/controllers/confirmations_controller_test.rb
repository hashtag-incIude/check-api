...
class ConfirmationsControllerTest < ActionController::TestCase
  ...
  test "should not confirm account if token is invalid" do
    u = create_user confirm: false
    get :show, params: { confirmation_token: u.confirmation_token.reverse, client_host: CONFIG['checkdesk_client'] }
  ...
  test "should redirect to already confirmed page if user is valid" do
    ...
    get :show, params: { confirmation_token: u.confirmation_token, client_host: CONFIG['checkdesk_client'] }
